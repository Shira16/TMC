...
import sktp.tmc.config.audit.AuditEventConverter;
import sktp.tmc.domain.PersistentAuditEvent;
...
import static sktp.tmc.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
